...
for i,tweet in enumerate(twitter.TwitterSearchScraper('from:Projects_007  lang:tr since:2020-01-01 until:2020-12-30').get_items()):
        if i > 1 : break  
        print(tweet.username)
        print(tweet.date)
        print(tweet.content)
...
for i,tweet in enumerate(sntwitter.TwitterSearchScraper(' conversation_id:1425083028695658504 (filter:safe OR -filter:safe) ').get_items()):
    print(tweet)
    print(i)
